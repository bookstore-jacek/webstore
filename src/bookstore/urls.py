...
from ExtOrder.views import find_order_view, all_orders_view, pending_orders_view, add_order_view, check_status_view
from ExtOrder.views import Orders_list_view
from Product.views import add_product_view, GeneratePdf, find_book_view
...
urlpatterns = [
    ...
    path('panel/zamowienie-hurtowe/', GeneratePdf, name='bulk_order'),
    path('panel/aktualne-zamowienia/', pending_orders_view, name='pending_orders'),
    path('panel/wszystkie-zamowienia/', Orders_list_view.as_view(), name='all_orders'),
]